...
@Controller('flower/transactions')
@ApiTags('flower - transactions')
...
export class TransactionGatewayController {
  ...
  async create(@Body() dto: any, @Request() req: any) {
    return this.flowerClient.send('flower.transactions.create', {
      userId: req.user.id,
      dto,
    });
  }
  ...
  async findAll(@Query() query: any, @Request() req: any) {
    return this.flowerClient.send('flower.transactions.findAll', {
      userId: req.user.id,
      filter: query,
    });
  }
  ...
  async findOne(@Param('id') id: string, @Request() req: any) {
    return this.flowerClient.send('flower.transactions.findOne', {
      id,
      userId: req.user.id,
    });
  }
  ...
  async update(@Param('id') id: string, @Body() dto: any, @Request() req: any) {
    return this.flowerClient.send('flower.transactions.update', {
      id,
      userId: req.user.id,
      dto,
    });
  ...
  async delete(@Param('id') id: string, @Request() req: any) {
    return this.flowerClient.send('flower.transactions.delete', {
      id,
      userId: req.user.id,
    });
  }
