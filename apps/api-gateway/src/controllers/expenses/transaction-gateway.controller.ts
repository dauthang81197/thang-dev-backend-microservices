...
export class TransactionGatewayController {
    ...
    @ApiResponse({ status: HttpStatus.CREATED, description: 'Transaction created. Wallet balance updated.' })
    ...
    @ApiQuery({ name: 'walletId', required: false, description: 'Filter by wallet ID' })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Paginated list of transactions' })
    ...
    @ApiParam({ name: 'id', description: 'Transaction ID (UUID)' })
    @ApiResponse({ status: HttpStatus.OK, description: 'Transaction updated. Wallet balance adjusted.' })
    async update(
        @Param('id') id: string,
        @Body() dto: any,
        @Request() req: any,
    ...
    @ApiParam({ name: 'id', description: 'Transaction ID (UUID)' })
    @ApiResponse({ status: HttpStatus.OK, description: 'Transaction deleted. Wallet balance reversed.' })
